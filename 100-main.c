 ...
 * @n2: Second node
 */
void launch_test(const binary_tree_t *n1, const binary_tree_t *n2)
{
...
int main(void)
{
	...
	root->right->right = binary_tree_node(root->right, 128);	root->left->left = binary_tree_node(root->left, 10);
